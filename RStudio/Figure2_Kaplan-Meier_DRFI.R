...
# Kaplan-meier - Metastasis free survival in all ER positive and HER2 negative patients according to Tumor size
km <- survfit(Surv(Met_25yr_16,MetBC25yr_16) ~ Tsize, data=bc_erp_nomissing)
table(bc_erp_nomissing$Tsize) #Frequency table for Tsize

# KM - what is the P-value
...
#Kaplan-meier - Metastasis free survival in all ER positive and HER2 negative patients according to Tumor grade
km <- survfit(Surv(Met_25yr_16,MetBC25yr_16) ~ grade, data=bc_erp_nomissing1)
...
#Kaplan-meier - Metastasis free survival in all ER positive and HER2 negative patients according to Tumor grade
km <- survfit(Surv(Met_25yr_16,MetBC25yr_16) ~ Prstatus_WT, data=bc_erp_nomissing2)
...
#Kaplan-meier - Metastasis free survival in all ER positive and HER2 negative patients according to Tumor grade
km <- survfit(Surv(Met_25yr_16,MetBC25yr_16) ~ Ki67status_WT, data=bc_erp_nomissing3)
