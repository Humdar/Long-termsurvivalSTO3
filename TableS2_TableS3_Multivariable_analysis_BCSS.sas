...
/*************** TUMOR SIZE : 559 observations ***************/  
	...
	Model Surv_25yr_16*CODBC25yr_16(0)= Tsize Tamoxifen PRStatus_WT KI67Status_WT Gradenm YR1_5 Age10/ risklimits;
	run;
	...
	Class Tamoxifen (ref='0' param=ref) PRStatus_WT(ref='Positive' param=ref)Ki67Status_WT(ref='Negative' param=ref)
		Gradenm(ref='2' param=ref) YR1_5(ref='3' param=ref)Age10(ref='2' param=ref);
	Model Surv_25yr_16*CODBC25yr_16(0)= Tamoxifen PRstatus_WT Ki67status_WT Gradenm YR1_5 age10/risklimits;
	Run;
...
/*************** TUMOR GRADE:  observations 557 ***************/  

	/* Only select patients that have tumor grade : 557 observations */
	...
	Model Surv_25yr_16*CODBC25yr_16(0)= Gradenm Tamoxifen PRStatus_WT KI67Status_WT Size20nm YR1_5 Age10/ risklimits;
	run;
	...
	Model Surv_25yr_16*CODBC25yr_16(0)= Tamoxifen PRStatus_WT KI67Status_WT Size20nm YR1_5 Age10/ risklimits;
	run;
...
/*************** PR status:  observations 559 ***************/  
	...
	proc freq data=TSiGr.PRERposHER2negnomissing;                                                                             
	tables CODBC25yr_16*PrStatus_WT;
	run;
	...
	Model Surv_25yr_16*CODBC25yr_16(0)= PRStatus_WT Tamoxifen KI67Status_WT Size20nm Gradenm YR1_5 Age10/ risklimits;
	run;
	...
	Class Tamoxifen(ref='0' param=ref) Ki67status_WT (ref='Negative' param=ref)
		size20nm(ref='0' param=ref)Gradenm(ref='1' param=ref)YR1_5(ref='3' param=ref)Age10(ref='2' param=ref);
	Model Surv_25yr_16*CODBC25yr_16(0)=  Tamoxifen KI67Status_WT Size20nm Gradenm YR1_5 Age10/ risklimits;
	run;
...
/*************** KI67 status:  535 observations  ***************/  
	...
	proc freq data=TSiGr.Ki67ERposHER2negnomissing;                                                                             
	tables CODBC25yr_16*Ki67Status_WT;
	run;
	...
	Class Ki67status_WT (ref='Negative' param=ref) Tamoxifen(ref='0' param=ref) Prstatus_WT(ref='Negative' param=ref)
		size20nm(ref='0' param=ref)Gradenm(ref='1' param=ref)YR1_5(ref='3' param=ref)Age10(ref='2' param=ref);
	Model Surv_25yr_16*CODBC25yr_16(0)= KI67Status_WT Tamoxifen PRStatus_WT  Size20nm Gradenm YR1_5 Age10/ risklimits;
	run;
	...
	Class Tamoxifen(ref='0' param=ref) Prstatus_WT(ref='Negative' param=ref)
		size20nm(ref='0' param=ref)Gradenm(ref='1' param=ref)YR1_5(ref='3' param=ref)Age10(ref='2' param=ref);
	Model Surv_25yr_16*CODBC25yr_16(0)= Tamoxifen PRStatus_WT  Size20nm Gradenm YR1_5 Age10/ risklimits;
	run;
